...
es: {
 ...
 lenNote: 'Recta = tramo recto de tangencia a tangencia; se teclea y reescribe el avance PI a PI. L = longitud del arco del doblez (radio × desvío). Σ L = longitud desarrollada acumulada sobre el eje neutro.',
...
en: {
 ...
 lenNote: 'Straight = tangent-to-tangent run; typing it rewrites the PI-to-PI feed. L = arc length of the bend (radius × deflection). Σ L = running developed length on the neutral axis.',
...
de: {
 ...
 lenNote: 'Gerade = gerades Stück von Tangente zu Tangente; wird sie eingetippt, schreibt sie den Vorschub von Schnittpunkt zu Schnittpunkt neu. L = Bogenlänge der Biegung (Radius × Auslenkung). Σ L = aufsummierte Abwicklungslänge auf der neutralen Faser.',
