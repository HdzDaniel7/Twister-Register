...
export const es: Record<I18nKey, string> = {
 ...
 pinRef: 'Medir contra',
 pinRefTip: 'Contra qué barra se mide TODO lo que lee la forma de la pieza: la libre —el diseño, la pieza fuera del fixture— o la que de verdad toma sujeta por los pines y colgada por su peso. Mueve las dos tablas (fixture y amarre), las cotas, la flecha, el color de los apoyos en el 3D, dónde nacen los pedestales y los pines que se siembran, y las cifras de cada tarjeta de modelo. Las dos preguntas son legítimas: la libre dice en qué se diferencian los diseños y dónde estaría la pieza sin nada que la sujetara; la sujeta, qué está pasando encima de la mesa. Lo único que no mueve es dónde se COLOCA la pieza: eso se ancla siempre contra la referencia libre, porque anclar contra la sujeta cierra un lazo y mover un pedestal recorre la barra entera.',
 pinMeasFree: 'Se está midiendo contra la barra LIBRE con el amarre o la carga puestos: esta tabla, las cotas y el sembrado contestan sobre la pieza que habría sin nada que la sujetara, no sobre la que hay encima de la mesa. Las reacciones no: salen del reparto de la pieza sujeta y siguen siendo las suyas. Elige «Sujeta» en «Medir contra», en la pestaña Amarre, para leer la barra que hay.',
