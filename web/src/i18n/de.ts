...
export const de: Record<I18nKey, string> = {
 ...
 pinRef: 'Messen gegen',
 pinRefTip: 'Gegen welche Stange ALLES gemessen wird, was die Form des Teils liest: die freie — den Entwurf, das Teil außerhalb der Vorrichtung — oder die, die es unter den Bolzen und unter dem eigenen Gewicht tatsächlich annimmt. Es bewegt beide Tabellen (Vorrichtung und Spannung), die Messpunkte, die Durchbiegung, die Farbe der Auflagen in der 3D-Ansicht, wo gesäte Böcke und Bolzen entstehen, und die Werte auf jeder Modellkarte. Beide Fragen sind berechtigt: die freie sagt, wie sich die Entwürfe unterscheiden und wo das Teil ohne Halt läge; die gehaltene sagt, was auf dem Tisch geschieht. Nur eines bewegt es nicht: wo das Teil GESETZT wird. Das wird immer gegen die freie Referenz ausgerichtet, denn gegen die gehaltene schließt sich eine Schleife und ein verschobener Bock verschiebt die ganze Stange.',
 pinMeasFree: 'Es wird gegen die FREIE Stange gemessen, obwohl Spannung oder Last eingeschaltet sind: diese Tabelle, die Messpunkte und das Säen antworten über das Teil, das es ohne jeden Halt gäbe, nicht über das auf dem Tisch. Die Reaktionen nicht: die stammen aus dem gehaltenen Teil und bleiben dessen eigene. Wähle «Gehalten» unter «Messen gegen» im Reiter Spannung, um die Stange zu lesen, die da ist.',
