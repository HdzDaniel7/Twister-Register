...
web/
  ...
  test_motor.js     590 pruebas del motor y del i18n, en Node y sin navegador
...
npm test             # 590 pruebas del motor y del i18n
npm run build        # regenera index.html (y web/barcomp_viewer.html en local)
npm run test:ui      # 281 pasos de interfaz en Edge headless, por CDP
